...
xxd -i -c 20 -n vertexShader140Arr   atari800-shader.140.vert > ./gen-atari800-shader.140.vert.h
xxd -i -c 20 -n fragmentShader140Arr atari800-shader.140.frag > ./gen-atari800-shader.140.frag.h
